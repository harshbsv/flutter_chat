...
import 'package:flutterchat/controllers/bindings/chatController.dart';
                    ...
                    children: [
                      Container(
                        ...
                        padding: const EdgeInsets.only(
                            left: 10, bottom: 20, top: 20, right: 8),
                        child: Text(
                          name,
                          style: GoogleFonts.poppins(
                              color: Colors.white,
                                    ...
                                    onFieldSubmitted: (message) async {
                                      if (message.length != 0) {
                                        await controller.sendMessage(
                                            to: uid,
                                            message: message,
                                            personSent: messageController.text);
                                        await controller.setLastSentMessage(
                                            to: uid,
                            ...
                            return new ListView(
                              ...
                              children: snapshot.data.docs
                                ...
                                if (document.data()['from'] ==
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            (obj.toDate().hour).toString() +
                                                ":" +
                                                obj.toDate().second.toString(),
                                  ...
                                  if (document.data()['from'] == uid &&
                                      document.data()['to'] ==
                                          FirebaseAuth
                                              .instance.currentUser.uid) {
                                    Timestamp obj =
                                        document.data()['created_on'];
                                    return Container(
                                      child: Row(
                                        mainAxisAlignment:
                                            MainAxisAlignment.spaceBetween,
